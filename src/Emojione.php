...
class Emojione
{
    ...
    public static $imagePathPNGSprites = 'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.2.7/assets/sprites/emojione.sprites.png';
    public static $imagePathSVGSprites = 'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.2.7/assets/sprites/emojione.sprites.svg';
